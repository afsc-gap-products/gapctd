...
#' @param use_rds See documentation for create_NMEA_files. Used to efficiently test thermal mass correction parameters.
#' @export

run_sbe_batch <- function(vessel, year, region, xmlcon_file = NA, bat_file = NA, derive_file = NA, rodbc_channel = NA, make_NMEA = TRUE, use_rds = FALSE) {
