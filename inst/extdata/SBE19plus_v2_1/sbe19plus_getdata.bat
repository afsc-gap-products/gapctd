...
@ Plot
@ Seaplot /i%1\final_cnv\*_A80.cnv /p%1\psa_xmlcon\SeaPlot.psa /o%1\plots\
@ Cell Thermal Mass correction
Celltm /i%1\cnv\*_align.cnv /p%1\psa_xmlcon\CellTM.psa /o%1\cnv\ /a_tmcorrect /c%1\psa_xmlcon\%2
@ Loop Edit
loopedit  /i%1\cnv\*_tmcorrect.cnv /p%1\psa_xmlcon\LoopEdit.psa /o%1\cnv\ /a_loopedit_wfil /c%1\psa_xmlcon\%2
