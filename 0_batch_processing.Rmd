...
The goal of this step is to flag large, transient errors. Small errors and errors that persist for multiple consecutive depth bins should not be removed.
