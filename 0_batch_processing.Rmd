...
To run batch processing with the estimated alignment parameters, pass the output of run_alignment_calcs (i.e., alignment_df) to run_method.
...
The move_to_final_cnv copies the best cnv files based on compare_methods to the final_cnv directory. Input is the best_df data.frame that was produced by compare_methods. 
...
## 11. Run density inversion check and correciton
