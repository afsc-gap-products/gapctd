...
cast_files <- c(
  list.files(path = "C:/Users/sean.rohan/Work/afsc/WIP/2026_AKK_8100/final_cnv/", full.names = TRUE),
  list.files(path = "C:/Users/sean.rohan/Work/afsc/WIP/2026_AKK_8102/final_cnv/", full.names = TRUE),
...
metadata_files <- c(
  list.files(path = "C:/Users/sean.rohan/Work/afsc/WIP/2026_AKK_8100/metadata/", full.names = TRUE),
  list.files(path = "C:/Users/sean.rohan/Work/afsc/WIP/2026_AKK_8102/metadata/", full.names = TRUE),
...
dataset_name <- "Water temperature, salinity, and others taken by trawl-mounted CTD from chartered fishing vessels during the 2026 Alaska Fisheries Science Center Eastern Bering Sea Annual Summer Bottom Trawl Survey"
