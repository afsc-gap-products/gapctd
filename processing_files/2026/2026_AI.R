...
cast_files <- c(
  list.files(path = "C:/Users/sean.rohan/Work/afsc/WIP/2026_AKP_8105/final_cnv/", full.names = TRUE),
  list.files(path = "C:/Users/sean.rohan/Work/afsc/WIP/2026_AKP_8106_L2/final_cnv/", full.names = TRUE),
  list.files(path = "C:/Users/sean.rohan/Work/afsc/WIP/2026_AKP_L1/final_cnv/", full.names = TRUE),
  list.files(path = "C:/Users/sean.rohan/Work/afsc/WIP/2026_OEX_8103/final_cnv/", full.names = TRUE)
)

# Replace this with paths to metadata rds files that should be included in the data product.
metadata_files <- c(
  list.files(path = "C:/Users/sean.rohan/Work/afsc/WIP/2026_AKP_8105/metadata/", full.names = TRUE),
  list.files(path = "C:/Users/sean.rohan/Work/afsc/WIP/2026_AKP_8106_L2/metadata/", full.names = TRUE),
  list.files(path = "C:/Users/sean.rohan/Work/afsc/WIP/2026_AKP_L1/metadata/", full.names = TRUE),
  list.files(path = "C:/Users/sean.rohan/Work/afsc/WIP/2026_OEX_8103/metadata/", full.names = TRUE)
)
...
year <- 2026
region <- "AI"
dataset_name <- "Water temperature, salinity, and others taken by trawl-mounted CTD from chartered fishing vessels Alaska Provider and Ocean Explorer during the 2026 Alaska Fisheries Science Center Aleutian Islands Biennial Summer Bottom Trawl Survey"
cruise_name <- "2026 Eastern Bering Sea Continental Shelf Survey"
ctd_team <- "Nicole Charriere, Bethany Riggle, Alexandra Dowlin, Pearl Rojas" # Do not list yourself!
creator_name <- "Sean Rohan" # your name
creator_email <- "sean.rohan@noaa.gov" # your email
dataset_citation <- "Rohan, S.K., Charriere, N.E., Riggle, B., O'Leary, C.A., Raring, N.W., Dowlin, A., Rojas, P. (2026). Water temperature, salinity, and others taken by trawl-mounted CTD from chartered fishing vessels during the 2022-2026 Alaska Fisheries Science Center Aleutian Islands Biennial Summer Bottom Trawl Surveys (NCEI Accession 0286094). [indicate subset used]. NOAA National Centers for Environmental Information. Dataset. https://doi.org/10.25921/rkh7-7a49. Accessed [date]."
