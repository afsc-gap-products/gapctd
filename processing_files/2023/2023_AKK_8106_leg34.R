# This CTD included pH and dissolved oxygen sensors in external voltage channels 0 and 1.
# As of September 21, the gapctd processing routine does not yet process pH or DO.
...
ctd_dir <- "G:/RACE_CTD/data/2023/ebs/v162_8106_leg3-4"
