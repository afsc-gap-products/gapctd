...
cast_files <- c(
  list.files(path = "C:/Users/sean.rohan/Work/afsc/WIP/2024_AKK/final_cnv/", full.names = TRUE),
  list.files(path = "C:/Users/sean.rohan/Work/afsc/WIP/2024_AKK_L1/final_cnv/", full.names = TRUE),
  list.files(path = "C:/Users/sean.rohan/Work/afsc/WIP/2024_NWE_8099/final_cnv/", full.names = TRUE),
  list.files(path = "C:/Users/sean.rohan/Work/afsc/WIP/2024_NWE_8100/final_cnv/", full.names = TRUE)
)

# Replace this with paths to metadata rds files that should be included in the data product.
metadata_files <- c(
  list.files(path = "C:/Users/sean.rohan/Work/afsc/WIP/2024_AKK/metadata/", full.names = TRUE),
  list.files(path = "C:/Users/sean.rohan/Work/afsc/WIP/2024_AKK_L1/metadata/", full.names = TRUE),
  list.files(path = "C:/Users/sean.rohan/Work/afsc/WIP/2024_NWE_8099/metadata/", full.names = TRUE),
  list.files(path = "C:/Users/sean.rohan/Work/afsc/WIP/2024_NWE_8100/metadata/", full.names = TRUE)
)
...
dataset_name <- "Water temperature, salinity, and others taken by trawl-mounted CTD from chartered fishing vessels during the 2024 Alaska Fisheries Science Center Eastern Bering Sea Annual Summer Bottom Trawl Survey"
cruise_name <- "2024 Eastern Bering Sea Continental Shelf and Northern Bering Sea Bottom-Trawl Surveys"
ctd_team <- "Nicole Charriere, Bethany Riggle, Nate Raring" # Do not list yourself!
