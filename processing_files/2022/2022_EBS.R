...
cast_files <- c(
  list.files(path = "C:/Users/sean.rohan/Work/afsc/WIP/2022_AKK/final_cnv/", full.names = TRUE),
...
metadata_files <- c(
  list.files(path = "C:/Users/sean.rohan/Work/afsc/WIP/2022_AKK/metadata/", full.names = TRUE),
...
data_set_name <- "CTD Data from AFSC 2022 EBS Shelf and NBS Bottom Trawl Surveys"
cruise_name <- "2022 Eastern Bering Sea Continental Shelf and Northern Bering Sea Bottom-Trawl Surveys"
