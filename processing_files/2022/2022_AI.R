...
cast_files <- c(
  ...
  list.files(path = "C:/Users/sean.rohan/Work/afsc/WIP/2022_AP_8102_LEG3/final_cnv/", full.names = TRUE),
...
metadata_files <- c(
  ...
  list.files(path = "C:/Users/sean.rohan/Work/afsc/WIP/2022_AP_8102_LEG3/metadata/", full.names = TRUE),
...
year <- 2022
region <- "AI"
data_set_name <- "CTD Data from AFSC 2022 Aleutian Islands Bottom Trawl Survey"
