...
text(x = 31.58, y = 35, labels = "(8) Piped")
```
...
The modules above can be used with any `ctd` object data from any CTD. However, some modules are specifically been developed for processing GAP's CTD data,
...
The use of thse functions within the data processing workflow is illustrated below.
